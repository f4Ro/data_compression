...
class Plotter:
    def __init__(
        self: Plotter, filename: str, plt: plt, backend: str = None,
        should_save: bool = True, should_plot: bool = False,
    ) -> None:
    ...
    def __call__(
        ...
        sub_path: str = '', should_save: bool = None, should_plot: bool = None,
        verbose: bool = False,
        dpi: int = 100
    ) -> None:
